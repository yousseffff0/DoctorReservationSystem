...
public class NeutralFeedbackController {
    private NeutralFeedbacks gui;
    private feedbackInterface feedbackInterface;

    public NeutralFeedbackController(NeutralFeedbacks gui) {
        this.gui = gui;
    ...
    private void attachEvents() {
        try {
            List<String> feedbacks = feedbackInterface.feedbackCall(3);
