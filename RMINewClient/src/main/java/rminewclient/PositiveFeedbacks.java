...
public class PositiveFeedbacks extends JFrame {
    private JTextArea recordsArea;
    private JButton closeButton;

    public PositiveFeedbacks() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        recordsArea.setForeground(Color.WHITE); // Set text color to white
        recordsArea.setBackground(new Color(44, 62, 80)); // Set background color
        ...
        closeButton.setBackground(new Color(52, 152, 219)); // Blue background
