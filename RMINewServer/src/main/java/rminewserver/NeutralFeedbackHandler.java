 ...
 * @author omar mohamed
 */
public class NeutralFeedbackHandler implements FeedbackHandler {
    ...
    public List<String> FeedbackHandlerr()throws RemoteException {
        ...
        try (MongoClient mongoClient = MongoClients.create("mongodb://localhost:27017")) {
            ...
            // Create a query to find documents where feedbackrate is between 4 and 6
            Document query = new Document("feedbackRate", new Document("$gte", 4).append("$lte", 6));
